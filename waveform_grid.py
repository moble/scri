            ...
            for i in range(5-w_modes.dataType):
                if i == 0:
                    if 'psi4_modes' in kwargs:
                        ...
                        raise ValueError('A supertranslation of {} requires mode data from Psi4.'.format(w_modes.data_type_string))
                elif i == 1:
                    if 'psi3_modes' in kwargs:
                        psin_modes = kwargs.pop('psi3_modes')
                    else:
                        raise ValueError('A supertranslation of {} also requires mode data from Psi3.'.format(w_modes.data_type_string))
                elif i == 2:
                    if 'psi2_modes' in kwargs:
                        psin_modes = kwargs.pop('psi2_modes')
                    else:
                        raise ValueError('A supertranslation of {} also requires mode data from Psi2.'.format(w_modes.data_type_string))
                elif i == 3:
                    if 'psi1_modes' in kwargs:
                        psin_modes = kwargs.pop('psi1_modes')
                    else:
                        raise ValueError('A supertranslation of {} also requires mode data from Psi1.'.format(w_modes.data_type_string))
